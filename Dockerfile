...
RUN export DEBIAN_FRONTEND=noninteractive; \
    ...
    php$PHP_VERSION-common php$PHP_VERSION-curl php$PHP_VERSION-json \
    ...
    php$PHP_VERSION-bz2 php$PHP_VERSION-bcmath php$PHP_VERSION-imap php$PHP_VERSION-mbstring \
    ...
    php$PHP_VERSION-memcached php$PHP_VERSION-redis  php$PHP_VERSION-amqp;
